    ...
    <nav className="bg-[#050B1B] text-white py-4 px-6 sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button className="border border-gray-500 hover:border-white text-xs px-5 py-1.5 rounded-full transition-colors">Sign Up</button>
          <button className="bg-white text-[#050B1B] text-xs font-semibold px-5 py-1.5 rounded-full hover:bg-gray-200 transition-colors">Log In</button>
        </div>
