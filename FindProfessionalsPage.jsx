      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          <div className="relative">
            <span className="absolute -inset-1 rounded-full blur-[2px] bg-white/20" />
      ...
      <main className="flex-grow w-full px-4 mb-16">
        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-xl p-6 md:p-10 min-h-[600px]">
          ...
          <div className="relative mb-6 group">
            <Search
              className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-400 group-focus-within:text-slate-600"
              size={18}
            />
            <input
              type="text"
